...
import 'halo_localizations_be.dart';
import 'halo_localizations_bg.dart';
import 'halo_localizations_bn.dart';
import 'halo_localizations_bs.dart';
import 'halo_localizations_ca.dart';
import 'halo_localizations_cs.dart';
import 'halo_localizations_de.dart';
import 'halo_localizations_el.dart';
import 'halo_localizations_en.dart';
import 'halo_localizations_es.dart';
import 'halo_localizations_et.dart';
import 'halo_localizations_fi.dart';
import 'halo_localizations_fr.dart';
import 'halo_localizations_hi.dart';
import 'halo_localizations_hr.dart';
import 'halo_localizations_hu.dart';
import 'halo_localizations_id.dart';
import 'halo_localizations_it.dart';
import 'halo_localizations_ja.dart';
import 'halo_localizations_kk.dart';
import 'halo_localizations_ko.dart';
import 'halo_localizations_lt.dart';
import 'halo_localizations_lv.dart';
import 'halo_localizations_ms.dart';
import 'halo_localizations_my.dart';
import 'halo_localizations_nl.dart';
import 'halo_localizations_pl.dart';
import 'halo_localizations_pt.dart';
import 'halo_localizations_ro.dart';
import 'halo_localizations_ru.dart';
import 'halo_localizations_sk.dart';
import 'halo_localizations_sl.dart';
import 'halo_localizations_sq.dart';
import 'halo_localizations_sr.dart';
import 'halo_localizations_sv.dart';
import 'halo_localizations_sw.dart';
import 'halo_localizations_ta.dart';
import 'halo_localizations_th.dart';
import 'halo_localizations_tl.dart';
import 'halo_localizations_tr.dart';
import 'halo_localizations_uk.dart';
import 'halo_localizations_vi.dart';
import 'halo_localizations_zh.dart';
...
///
/// ```dart
/// import 'gen/halo_localizations.dart';
///
/// return MaterialApp(
...
abstract class Str {
  ...
  /// No description provided for @aff_commission_hotel.
  ///
  /// In en, this message translates to:
  /// **'Hotel commissions'**
  String get aff_commission_hotel;

  /// No description provided for @aff_commission_list_hotel_by_country.
  ///
  /// In en, this message translates to:
  /// **'List of hotel commissions by country'**
  String get aff_commission_list_hotel_by_country;
  ...
  /// No description provided for @aff_select_date.
  ///
  /// In en, this message translates to:
  /// **'Select date'**
  String get aff_select_date;

  /// No description provided for @aff_select_status.
  ///
  /// In en, this message translates to:
  /// **'Select status'**
  String get aff_select_status;

  /// No description provided for @aff_date_months.
  ///
  /// In en, this message translates to:
  /// **'months'**
  String get aff_date_months;

  /// No description provided for @aff_date_days.
  ///
  /// In en, this message translates to:
  /// **'days'**
  String get aff_date_days;

  /// No description provided for @aff_date_hours.
  ///
  /// In en, this message translates to:
  /// **'hours'**
  String get aff_date_hours;

  /// No description provided for @aff_date_minutes.
  ///
  /// In en, this message translates to:
  /// **'minutes'**
  String get aff_date_minutes;

  /// No description provided for @aff_date_seconds.
  ///
  /// In en, this message translates to:
  /// **'seconds'**
  String get aff_date_seconds;

  /// No description provided for @aff_wallet_block_title.
  ///
  /// In en, this message translates to:
  /// **'Invalid payment account'**
  String get aff_wallet_block_title;

  /// No description provided for @aff_wallet_block_content.
  ///
  /// In en, this message translates to:
  /// **'To use the sales function on Hahalolo, you must have a valid payment account. Please check your payment account again.'**
  String get aff_wallet_block_content;

  /// No description provided for @aff_wallet_check_payment_account.
  ///
  /// In en, this message translates to:
  /// **'Check payment account'**
  String get aff_wallet_check_payment_account;

  /// No description provided for @aff_wallet_subtitle_update.
  ///
  /// In en, this message translates to:
  /// **'Please update the missing required information below for your payment account to be able to continue using services on Hahalolo.'**
  String get aff_wallet_subtitle_update;

  /// No description provided for @aff_notification_content.
  ///
  /// In en, this message translates to:
  /// **'The commission of {product} order {orderDisplayCode} has been added to your payment account'**
  String get aff_notification_content;

  /// No description provided for @aff_sms_expired_code.
  ///
  /// In en, this message translates to:
  /// **'The verification code has expired, please get another one'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Please register your payment account to be able to use sales services on Hahalolo'**
  String get aff_verify_do_not_have_account_subtitle;

  /// No description provided for @aff_verify_invalid_wallet_subtitle.
  ///
  /// In en, this message translates to:
  /// **'Please fully update your payment account to be able to use sales services on Hahalolo'**
  String get aff_verify_invalid_wallet_subtitle;

  /// No description provided for @aff_request_verify.
  ///
  /// In en, this message translates to:
  /// **'Verification request'**
  String get aff_request_verify;

  /// No description provided for @aff_seller_unverified.
  ///
  /// In en, this message translates to:
  /// **'Unverified'**
  String get aff_seller_unverified;

  /// No description provided for @aff_seller_verifying.
  ///
  /// In en, this message translates to:
  /// **'Waiting for verification'**
  String get aff_seller_verifying;

  /// No description provided for @aff_seller_verified.
  ///
  /// In en, this message translates to:
  /// **'Verified'**
  String get aff_seller_verified;

  /// No description provided for @aff_seller_unverified_title.
  ///
  /// In en, this message translates to:
  /// **'Your seller account has not been verified!'**
  String get aff_seller_unverified_title;

  /// No description provided for @aff_seller_verifying_title.
  ///
  /// In en, this message translates to:
  /// **'Your seller account is being verified!'**
  String get aff_seller_verifying_title;

  /// No description provided for @aff_seller_unverified_content.
  ///
  /// In en, this message translates to:
  /// **'Please tap the Verification Request button below to ensure your rights on Hahalolo.'**
  String get aff_seller_unverified_content;

  /// No description provided for @aff_seller_rejceted_content.
  ///
  /// In en, this message translates to:
  /// **'Sorry, your seller account has not been verified. Please make a request to re-verify your account or contact our Customer Service for assistance.'**
  String get aff_seller_rejceted_content;

  /// No description provided for @aff_seller_rejceted_content_customer_service.
  ///
  /// In en, this message translates to:
  /// **'Sorry, your seller account has not been verified. Please make a request to re-verify your account or contact our {customerService} for assistance.'**
  String get aff_seller_rejceted_content_customer_service;

  /// No description provided for @aff_seller_rejceted_content_reason.
  ///
  /// In en, this message translates to:
  /// **'Reason: {reason}'**
  String aff_seller_rejceted_content_reason(Object reason);

  /// No description provided for @aff_seller_verifying_content.
  ///
  /// In en, this message translates to:
  /// **'You have successfully submitted a verification request to Hahalolo Help Center. We will respond to you as soon as possible.'**
  String get aff_seller_verifying_content;

  /// No description provided for @aff_transaction_code.
  ///
  /// In en, this message translates to:
  /// **'Transaction code'**
  String get aff_transaction_code;

  /// No description provided for @aff_search_by_transaction_code.
  ///
  /// In en, this message translates to:
  /// **'Search by transaction code'**
  String get aff_search_by_transaction_code;

  /// No description provided for @aff_notification_seller_approval_content.
  ///
  /// In en, this message translates to:
  /// **'Congratulations! Your seller account has been successfully verified'**
  String get aff_notification_seller_approval_content;

  /// No description provided for @aff_seller_verify_request_failed.
  ///
  /// In en, this message translates to:
  /// **'Verification request failed'**
  String get aff_seller_verify_request_failed;

  /// No description provided for @aff_customer_service.
  ///
  /// In en, this message translates to:
  /// **'Customer Service'**
  String get aff_customer_service;
  ...
  /// No description provided for @wallet_war_update_payout_info.
  ///
  /// In en, this message translates to:
  /// **'Your bank name information needs updating. Please click the button below to update it.'**
  String get wallet_war_update_payout_info;
  ...
  /// No description provided for @wallet_status_declined.
  ///
  /// In en, this message translates to:
  /// **'Declined'**
  String get wallet_status_declined;

  /// No description provided for @wallet_label_need_update.
  ///
  /// In en, this message translates to:
  /// **'Need update'**
  String get wallet_label_need_update;
  ...
  /// No description provided for @wallet_validate_update_bank_info.
  ///
  /// In en, this message translates to:
  /// **'Your bank name information needs updating.'**
  String get wallet_validate_update_bank_info;
  ...
  ///
  /// In en, this message translates to:
  /// **'(Note: {HAHALOLO} shall support users with {MIỄN PHÍ} bank charges)'**
  ...
  /// No description provided for @wallet_number_point_min_max_invalid.
  ///
  /// In en, this message translates to:
  /// **'The number of points must be greater than or equal to 5 and less than or equal to 1000'**
  String get wallet_number_point_min_max_invalid;

  /// No description provided for @wallet_min_withdrawal_amount.
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'The maximum limit of {fieldName} is {maxLength} characters.'**
  ...
  /// No description provided for @wallet_unknown.
  ///
  /// In en, this message translates to:
  /// **'Unknown'**
  String get wallet_unknown;

  /// No description provided for @wallet_payment_account_name.
  ///
  /// In en, this message translates to:
  /// **'Payment account name'**
  String get wallet_payment_account_name;

  /// No description provided for @wallet_action_done.
  ///
  /// In en, this message translates to:
  /// **'Done'**
  String get wallet_action_done;

  /// No description provided for @wallet_create_payout_confirm_policies_description.
  ///
  /// In en, this message translates to:
  /// **'By clicking {done}, you confirm that you have read and agreed to the {termsAndPolicies} and agree to Hahalolo\'s use of the account information you provided to proceed with the transfer.'**
  String get wallet_create_payout_confirm_policies_description;

  /// No description provided for @wallet_buy_point_confirm_policies_description.
  ///
  /// In en, this message translates to:
  /// **'By proceeding with the next step, I confirm that I have read and agreed to the {termPolicies} and {privacyPolicy} of Hahalolo'**
  String get wallet_buy_point_confirm_policies_description;

  /// No description provided for @wallet_btn_pay.
  ///
  /// In en, this message translates to:
  /// **'Pay'**
  String get wallet_btn_pay;

  /// No description provided for @wallet_validate_otp_full_length.
  ///
  /// In en, this message translates to:
  /// **'Please complete the 6-digit verification code.'**
  String get wallet_validate_otp_full_length;

  /// No description provided for @wallet_halo_term_and_policies.
  ///
  /// In en, this message translates to:
  /// **'Hahalolo\'s terms and policies'**
  String get wallet_halo_term_and_policies;

  /// No description provided for @wallet_label_amount.
  ///
  /// In en, this message translates to:
  /// **'Amount'**
  String get wallet_label_amount;

  /// No description provided for @wallet_validate_no_tone_mark.
  ///
  /// In en, this message translates to:
  /// **'{field} (no tone-mark) contains only the characters a-z'**
  String wallet_validate_no_tone_mark(String field);

  /// No description provided for @wallet_payout_lack_information.
  ///
  /// In en, this message translates to:
  /// **'Complete your payment account details for express money withdrawal!'**
  String get wallet_payout_lack_information;

  /// No description provided for @wallet_action_edit.
  ///
  /// In en, this message translates to:
  /// **'Edit'**
  String get wallet_action_edit;

  /// No description provided for @wallet_transaction_detail.
  ///
  /// In en, this message translates to:
  /// **'transaction detail'**
  String get wallet_transaction_detail;

  /// No description provided for @wallet_transaction_id.
  ///
  /// In en, this message translates to:
  /// **'Transaction ID'**
  String get wallet_transaction_id;

  /// No description provided for @wallet_transaction_time.
  ///
  /// In en, this message translates to:
  /// **'Transaction time'**
  String get wallet_transaction_time;

  /// No description provided for @wallet_transaction_reason.
  ///
  /// In en, this message translates to:
  /// **'Reason'**
  String get wallet_transaction_reason;

  /// No description provided for @wallet_payout_account.
  ///
  /// In en, this message translates to:
  /// **'Payout Account'**
  String get wallet_payout_account;

  /// No description provided for @wallet_error_missing_bank_information.
  ///
  /// In en, this message translates to:
  /// **'Missing bank account information'**
  String get wallet_error_missing_bank_information;

  /// No description provided for @wallet_blocked_dialog_content.
  ///
  /// In en, this message translates to:
  /// **'Your payment account is temporarily {blocking}. Please contact customer service via hotline {hotline} for support.'**
  String get wallet_blocked_dialog_content;

  /// No description provided for @wallet_blocking.
  ///
  /// In en, this message translates to:
  /// **'locked'**
  String get wallet_blocking;

  /// No description provided for @wallet_verify_method.
  ///
  /// In en, this message translates to:
  /// **'Verification method'**
  String get wallet_verify_method;

  /// No description provided for @wallet_verify_method_sub.
  ///
  /// In en, this message translates to:
  /// **'Please select the verification method'**
  String get wallet_verify_method_sub;

  /// No description provided for @wallet_verify_send_sms.
  ///
  /// In en, this message translates to:
  /// **'Send message to the phone number {phone}'**
  String wallet_verify_send_sms(String phone);

  /// No description provided for @wallet_verify_send_email.
  ///
  /// In en, this message translates to:
  /// **'Send email to {email}'**
  String wallet_verify_send_email(String email);

  /// No description provided for @wallet_validate_email_existed.
  ///
  /// In en, this message translates to:
  /// **'Email already registered for another payment account.'**
  String get wallet_validate_email_existed;
  ...
  /// No description provided for @flight_v2_click_again_to_unselected.
  ///
  /// In en, this message translates to:
  /// **'Click again to deselect'**
  String get flight_v2_click_again_to_unselected;

  /// No description provided for @flight_v2_before_payment.
  ///
  /// In en, this message translates to:
  /// **'Prepayment'**
  String get flight_v2_before_payment;

  /// No description provided for @flight_v2_user_payment.
  ///
  /// In en, this message translates to:
  /// **'Contact person'**
  String get flight_v2_user_payment;

  /// No description provided for @flight_v2_use_info_payment_of.
  ///
  /// In en, this message translates to:
  /// **'Use your payment information:'**
  String get flight_v2_use_info_payment_of;

  /// No description provided for @flight_v2_warning_full_name.
  ///
  /// In en, this message translates to:
  /// **'Full name as shown in ID card/ID card/Passport'**
  String get flight_v2_warning_full_name;

  /// No description provided for @flight_v2_note_payment_check_box_form.
  ///
  /// In en, this message translates to:
  /// **'\'{note}\': This information will be used directly on the ticket. Please check for accuracy.'**
  String get flight_v2_note_payment_check_box_form;

  /// No description provided for @flight_v2_note_payment_check_box_form_note.
  ///
  /// In en, this message translates to:
  /// **'Note'**
  String get flight_v2_note_payment_check_box_form_note;
  ...
  /// No description provided for @site_setting_category_title.
  ///
  /// In en, this message translates to:
  /// **'Category'**
  String get site_setting_category_title;

  /// No description provided for @site_setting_introduction_title.
  ///
  /// In en, this message translates to:
  /// **'Title'**
  String get site_setting_introduction_title;

  /// No description provided for @site_setting_introduction_title_empty_error.
  ///
  /// In en, this message translates to:
  /// **'Title can not be empty'**
  String get site_setting_introduction_title_empty_error;

  /// No description provided for @site_setting_introduction_title_invalid_error.
  ///
  /// In en, this message translates to:
  /// **'Invalid title'**
  String get site_setting_introduction_title_invalid_error;

  /// No description provided for @site_setting_introduction_content.
  ///
  /// In en, this message translates to:
  /// **'Content'**
  String get site_setting_introduction_content;

  /// No description provided for @site_setting_introduction_content_empty_error.
  ///
  /// In en, this message translates to:
  /// **'Content can not be empty'**
  String get site_setting_introduction_content_empty_error;

  /// No description provided for @site_setting_introduction_content_invalid_error.
  ///
  /// In en, this message translates to:
  /// **'Invalid content'**
  String get site_setting_introduction_content_invalid_error;

  /// No description provided for @site_setting_introduction_data_changed_warning.
  ///
  /// In en, this message translates to:
  /// **'Your unsaved changes will be lost if you leave the page.'**
  String get site_setting_introduction_data_changed_warning;

  /// No description provided for @site_setting_introduction_update_success.
  ///
  /// In en, this message translates to:
  /// **'Update successful'**
  String get site_setting_introduction_update_success;

  /// No description provided for @site_setting_introduction_update_failure.
  ///
  /// In en, this message translates to:
  /// **'update failed'**
  String get site_setting_introduction_update_failure;

  /// No description provided for @site_setting_introduction_app_bar_title.
  ///
  /// In en, this message translates to:
  /// **'Introduction'**
  String get site_setting_introduction_app_bar_title;

  /// No description provided for @site_setting_introduction_choose_a_source.
  ///
  /// In en, this message translates to:
  /// **'Choose picture'**
  String get site_setting_introduction_choose_a_source;

  /// No description provided for @site_setting_introduction_choose_a_source_camera.
  ///
  /// In en, this message translates to:
  /// **'Camera'**
  String get site_setting_introduction_choose_a_source_camera;

  /// No description provided for @site_setting_introduction_choose_a_source_library.
  ///
  /// In en, this message translates to:
  /// **'Library'**
  String get site_setting_introduction_choose_a_source_library;

  /// No description provided for @page_no_phone.
  ///
  /// In en, this message translates to:
  /// **'Trang của tôi không có số điện thoại'**
  String get page_no_phone;

  /// No description provided for @page_no_email.
  ///
  /// In en, this message translates to:
  /// **'Trang của tôi không có Email'**
  String get page_no_email;

  /// No description provided for @page_no_web.
  ///
  /// In en, this message translates to:
  /// **'Trang của tôi không có trang web'**
  String get page_no_web;

  /// No description provided for @phone_submit_info.
  ///
  /// In en, this message translates to:
  /// **'Số điện thoại'**
  String get phone_submit_info;

  /// No description provided for @page_web.
  ///
  /// In en, this message translates to:
  /// **'Trang web'**
  String get page_web;

  /// No description provided for @page_description.
  ///
  /// In en, this message translates to:
  /// **'Mô tả'**
  String get page_description;

  /// No description provided for @page_author.
  ///
  /// In en, this message translates to:
  /// **'Quyền tác giả'**
  String get page_author;

  /// No description provided for @page_reward.
  ///
  /// In en, this message translates to:
  /// **'Giải thưởng'**
  String get page_reward;

  /// No description provided for @page_private.
  ///
  /// In en, this message translates to:
  /// **'Chính sách riêng tư trang'**
  String get page_private;

  /// No description provided for @page_code.
  ///
  /// In en, this message translates to:
  /// **'Mã trang'**
  String get page_code;
  ...
  /// No description provided for @input_web.
  ///
  /// In en, this message translates to:
  /// **'Nhập trang tổ chức'**
  String get input_web;

  /// No description provided for @input_description.
  ///
  /// In en, this message translates to:
  /// **'Mô tả'**
  String get input_description;

  /// No description provided for @input_author.
  ///
  /// In en, this message translates to:
  /// **'Nhập quyền tác giả'**
  String get input_author;

  /// No description provided for @input_reward.
  ///
  /// In en, this message translates to:
  /// **'Nhập giải thưởng'**
  String get input_reward;

  /// No description provided for @input_private.
  ///
  /// In en, this message translates to:
  /// **'Chính sách riêng tư trang'**
  String get input_private;

  /// No description provided for @input_code.
  ///
  /// In en, this message translates to:
  /// **'Nhập mã trang'**
  String get input_code;

  /// No description provided for @limit_length_character.
  ///
  /// In en, this message translates to:
  /// **'Giới hạn {count} ký tự'**
  ...
  /// No description provided for @change_username_msg_success.
  ///
  /// In en, this message translates to:
  /// **'Update username successfully'**
  String get change_username_msg_success;

  /// No description provided for @social_validate_username_title.
  ///
  /// In en, this message translates to:
  /// **'The username must match the name displayed on your timeline:'**
  String get social_validate_username_title;
  ...
  /// No description provided for @social_update_username_note.
  ///
  /// In en, this message translates to:
  /// **'The username should include your authentic name'**
  String get social_update_username_note;

  /// No description provided for @limit_length_validate.
  ///
  /// In en, this message translates to:
  /// **'The minimum limit of {field} is {length} characters.'**
  ...
  /// No description provided for @field_contains_special_character.
  ///
  /// In en, this message translates to:
  /// **'{field} contains special characters'**
  String field_contains_special_character(Object field);

  /// No description provided for @halo_error_caught_up.
  ///
  /// In en, this message translates to:
  /// **'You\'re all caught up!'**
  String get halo_error_caught_up;

  /// No description provided for @halo_error_wifi_error.
  ///
  /// In en, this message translates to:
  /// **'Wifi error'**
  String get halo_error_wifi_error;

  /// No description provided for @halo_error_something_wrong.
  ///
  /// In en, this message translates to:
  /// **'Oops!\nSomething went wrong,please try again'**
  String get halo_error_something_wrong;
}
...
class _StrDelegate extends LocalizationsDelegate<Str> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['be', 'bg', 'bn', 'bs', 'ca', 'cs', 'de', 'el', 'en', 'es', 'et', 'fi', 'fr', 'hi', 'hr', 'hu', 'id', 'it', 'ja', 'kk', 'ko', 'lt', 'lv', 'ms', 'my', 'nl', 'pl', 'pt', 'ro', 'ru', 'sk', 'sl', 'sq', 'sr', 'sv', 'sw', 'ta', 'th', 'tl', 'tr', 'uk', 'vi', 'zh'].contains(locale.languageCode);
...
Str lookupStr(Locale locale) {
  ...
  switch (locale.languageCode) {
    case 'be': return StrBe();
    case 'bg': return StrBg();
    case 'bn': return StrBn();
    case 'bs': return StrBs();
    case 'ca': return StrCa();
    case 'cs': return StrCs();
    case 'de': return StrDe();
    case 'el': return StrEl();
    case 'en': return StrEn();
    case 'es': return StrEs();
    case 'et': return StrEt();
    case 'fi': return StrFi();
    case 'fr': return StrFr();
    case 'hi': return StrHi();
    case 'hr': return StrHr();
    case 'hu': return StrHu();
    case 'id': return StrId();
    case 'it': return StrIt();
    case 'ja': return StrJa();
    case 'kk': return StrKk();
    case 'ko': return StrKo();
    case 'lt': return StrLt();
    case 'lv': return StrLv();
    case 'ms': return StrMs();
    case 'my': return StrMy();
    case 'nl': return StrNl();
    case 'pl': return StrPl();
    case 'pt': return StrPt();
    case 'ro': return StrRo();
    case 'ru': return StrRu();
    case 'sk': return StrSk();
    case 'sl': return StrSl();
    case 'sq': return StrSq();
    case 'sr': return StrSr();
    case 'sv': return StrSv();
    case 'sw': return StrSw();
    case 'ta': return StrTa();
    case 'th': return StrTh();
    case 'tl': return StrTl();
