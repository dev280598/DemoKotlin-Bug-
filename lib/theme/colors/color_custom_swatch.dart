...
class ColorTonalPaletteSwatch extends ColorSwatch<int> {
  const ColorTonalPaletteSwatch(super.primary, super.swatch);

  List<int> get commonTones =>
